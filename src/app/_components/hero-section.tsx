  ...
  return (
    ...
    >
      <div className="absolute left-[5vw] right-[5vw] top-8 border-t border-[rgba(175,189,216,0.3)]" />
        <div className="relative z-10 max-w-[45rem] self-center pb-12">
      ...
      <div className="relative z-10 min-w-0 self-center max-[900px]:mx-auto max-[900px]:mb-16 max-[900px]:mt-8 max-[900px]:w-full max-[900px]:max-w-[42rem]">
        <DetectorEvent />
      </div>
      <div className="relative z-10 col-span-full flex items-center gap-[1.6rem] self-end border-t border-[rgba(175,189,216,0.3)] pb-0 pt-4 text-[0.6rem] uppercase tracking-[0.14em] text-brand-muted max-[620px]:flex-wrap max-[620px]:gap-x-4 max-[620px]:gap-y-[0.65rem]">
        <span>FZ / BR</span>
